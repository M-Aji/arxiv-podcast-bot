...
1. [Distributed Attacks in Persistent-State AI Control](https://arxiv.org/abs/2607.02514) — score 5.0  
   邦訳: (翻訳失敗)
2. [LACUNA: A Testbed for Evaluating Localization Precision for LLM Unlearning](https://arxiv.org/abs/2607.02513) — score 5.0  
   邦訳: (翻訳失敗)
3. [Program-as-Weights: A Programming Paradigm for Fuzzy Functions](https://arxiv.org/abs/2607.02512) — score 5.0  
   邦訳: (翻訳失敗)
4. [Online Safety Monitoring for LLMs](https://arxiv.org/abs/2607.02510) — score 5.0  
   邦訳: (翻訳失敗)
5. [ReContext: Recursive Evidence Replay as LLM Harness for Long-Context Reasoning](https://arxiv.org/abs/2607.02509) — score 5.0  
   邦訳: (翻訳失敗)
...
**Category:** cs.CL
**Published:** 2026-07-02
**arXiv:** https://arxiv.org/abs/2607.02504
...
**Category:** cs.LG
**Published:** 2026-07-02
**arXiv:** https://arxiv.org/abs/2607.02499
